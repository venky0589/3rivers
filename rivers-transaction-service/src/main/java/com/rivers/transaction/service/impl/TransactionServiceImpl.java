package com.rivers.transaction.service.impl;
...
import com.rivers.transaction.repository.TransactionRepository;
import com.rivers.transaction.service.MongoSequenceService;
...
public class TransactionServiceImpl implements TransactionService {
	...
	public void saveTransaction(TransactionPayload transactionPayload) {
		...
		log.debug("AccountResponse: {}", accountResponse);
