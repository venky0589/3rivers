package com.rivers.transaction.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TransactionPayload> transactionConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(TransactionPayload.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransactionPayload> transactionKafkaListenerFactory() {
